...
class TimezoneTest : public CppUnit::TestFixture
{
  ...
  public:
    ...
    {
      CPPUNIT_ASSERT_EQUALS (utc->GetOffset (),        0);
      CPPUNIT_ASSERT_EQUALS (utcMinus10->GetOffset (), -10*60);
      CPPUNIT_ASSERT_EQUALS (utcPlus4->GetOffset (),   4*60);
      CPPUNIT_ASSERT_EQUALS (utcPlus1->GetOffset (),   1*60);
    }
    ...
    void testCompare (void)
    {
      ...
      CPPUNIT_ASSERT_ASSERTION_PASS (CPPUNIT_ASSERT (utcMinus10 == utcMinus10));
      ...
      CPPUNIT_ASSERT_ASSERTION_FAIL (CPPUNIT_ASSERT (utcMinus10 != utcMinus10));
    ...
    {
      Timezone test (utc);
      CPPUNIT_ASSERT_EQUALS (test, utc);
      test = *utcMinus10;
      CPPUNIT_ASSERT_EQUALS (test, utcMinus10);
    }
